...
public class verifyTask1_1 extends TestSetup{
private String TCParam="";
@BeforeTest(alwaysRun = true)
@Parameters({"driverID","skipOtherTCsWhenFailed"})
public void beforeTest(String dr,String skipOtherTCsWhenFailed) {
dr= Reporter.getCurrentTestResult().getTestContext().getSuite().getName();
outputtextList.get(dr).setTestCaseID("887658264198643712");
outputtextList.get(dr).setTestCaseDesc("一级审核");
...
@Test(dependsOnMethods ="Step1",timeOut = 180000,description="MoveToElement:点击管理员",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step2",timeOut = 180000,description="waitingForClickOrInput:点击模拟登录",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step3",timeOut = 180000,description="waitingForClickOrInput:输入搜索人员",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step4",timeOut = 180000,description="KeyboardOperation:回车",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step5",timeOut = 180000,description="waitingForClickOrInput:选中人员",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step6",timeOut = 180000,description="waitingForClickOrInput:点击确定",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step7",timeOut = 180000,description="MoveToElement:点击支撑管理菜单",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step8",timeOut = 180000,description="waitingForClickOrInput:点击任务审核菜单",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step9",timeOut = 180000,description="waitForAttributeContains:等待可见",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step10",timeOut = 180000,description="Verify_AnyContain:校验文本",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
public void Step11(String dr,String paramGroup) throws Exception {
dr= Reporter.getCurrentTestResult().getTestContext().getSuite().getName();
String testObject="列表第一条";
String byString= pageObject6.POString.get(testObject);
String testData ="一级审核";
outputtextList.get(dr).setMethodName("Verify_AnyContain：校验文本");
outputtextList.get(dr).setScreenshot(true);
ApplicationActions.Verify_AnyContain(dr,byString,testData);
}
@Test(dependsOnMethods ="Step11",timeOut = 180000,description="filterByTitle:输入项目名称查询",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step12",timeOut = 180000,description="clickByTitle:进入项目详情",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step13",timeOut = 180000,description="waitingForClickOrInput:点击审核通过",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step14",timeOut = 180000,description="waitingForClickOrInput:输入审核意见",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step15",timeOut = 180000,description="waitingForClickOrInput:点击确定",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step16",timeOut = 180000,description="WaitOn:等待5s",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step17",timeOut = 180000,description="Verify_AnyContain:校验文本",alwaysRun = true)
@Parameters({"driverID","paramGroup"})
