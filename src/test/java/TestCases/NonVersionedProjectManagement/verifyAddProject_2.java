...
public class verifyAddProject_2 extends TestSetup{
private String TCParam="";
@BeforeTest(alwaysRun = true)
@Parameters({"driverID","skipOtherTCsWhenFailed"})
public void beforeTest(String dr,String skipOtherTCsWhenFailed) {
dr= Reporter.getCurrentTestResult().getTestContext().getSuite().getName();
outputtextList.get(dr).setTestCaseID("893130533276483584");
...
@Test(dependsOnMethods ="Step0",timeOut = 180000,description="WaitOn:等待5s",alwaysRun = false)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step1",timeOut = 180000,description="Verify_AnyContain:校验文本",alwaysRun = false)
@Parameters({"driverID","paramGroup"})
