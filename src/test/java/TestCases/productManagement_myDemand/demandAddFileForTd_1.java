...
public class demandAddFileForTd_1 extends TestSetup{
private String TCParam="";
@BeforeTest(alwaysRun = true)
@Parameters({"driverID","skipOtherTCsWhenFailed"})
public void beforeTest(String dr,String skipOtherTCsWhenFailed) {
dr= Reporter.getCurrentTestResult().getTestContext().getSuite().getName();
outputtextList.get(dr).setTestCaseID("887658257059938304");
outputtextList.get(dr).setTestCaseDesc("需求管理_新建技术文档");
outputtextList.get(dr).setSkipOtherTCsWhenFailed(Integer.parseInt(skipOtherTCsWhenFailed));
}
@Test(timeOut = 180000,description="waitingForClickOrInput:点击新建文档",alwaysRun = false)
...
String testData ="";
outputtextList.get(dr).setMethodName("waitingForClickOrInput：点击新建文档");
...
String byString= pageObject23.POString.get(testObject);
String testData ="/TestData/QM-GC08.0035-2021 附件4：IT项目Git管理规程.docx";
