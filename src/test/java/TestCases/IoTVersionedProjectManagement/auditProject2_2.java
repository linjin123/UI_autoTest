...
public class auditProject2_2 extends TestSetup{
private String TCParam="";
@BeforeTest(alwaysRun = true)
@Parameters({"driverID","skipOtherTCsWhenFailed"})
public void beforeTest(String dr,String skipOtherTCsWhenFailed) {
dr= Reporter.getCurrentTestResult().getTestContext().getSuite().getName();
outputtextList.get(dr).setTestCaseID("910922454048702464");
outputtextList.get(dr).setTestCaseDesc("审核项目_角色2");
...
@Test(dependsOnMethods ="Step8",timeOut = 180000,description="waitForAttributeContains:等待可见",alwaysRun = false)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step14",timeOut = 180000,description="waitingForClickOrInput:审核通过",alwaysRun = false)
@Parameters({"driverID","paramGroup"})
...
@Test(dependsOnMethods ="Step15",timeOut = 180000,description="waitingForClickOrInput:审核通过确定",alwaysRun = false)
@Parameters({"driverID","paramGroup"})
