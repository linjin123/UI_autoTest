...
public class verifyAddProject2_1 extends TestSetup{
private String TCParam="";
@BeforeTest(alwaysRun = true)
@Parameters({"driverID","skipOtherTCsWhenFailed"})
public void beforeTest(String dr,String skipOtherTCsWhenFailed) {
dr= Reporter.getCurrentTestResult().getTestContext().getSuite().getName();
outputtextList.get(dr).setTestCaseID("897798509510524928");
outputtextList.get(dr).setTestCaseDesc("数据校验_进行中");
...
@Test(dependsOnMethods ="Step6",timeOut = 180000,description="waitingForClickOrInput:点击项目列表菜单",alwaysRun = false)
@Parameters({"driverID","paramGroup"})
