...
POString.put("审批通过按钮","cssSelector;;div.gppm-margin button:nth-child(2)");
...
POString.put("打开流程链接","cssSelector;;.contextmenu li:first-child span");
POString.put("立项搜索栏","cssSelector;;thead.has-gutter  th:nth-child(3) input[type=text]");
POString.put("立项流程链接","cssSelector;;a[ui-title^=UI自动化测试项目]");
}
}
