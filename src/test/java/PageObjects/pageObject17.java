...
POString.put("提交审核弹框确认按钮","cssSelector;;div[aria-label=提交审核].el-dialog button.el-button--primary");
POString.put("立项搜索栏","cssSelector;;thead.has-gutter  th:nth-child(3) input[type=text]");
POString.put("立项流程链接","cssSelector;;a[ui-title^=UI自动化测试试产单]");
POString.put("通过弹框确认按钮","cssSelector;;div[aria-label=通过].el-dialog button.el-button--primary");
}
}
